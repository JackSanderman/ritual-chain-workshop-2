/**
 * Deploy DriftGuard to Ritual Chain and prepay its scheduled read fees.
 *
...
console.log("Create a drift market from a public JSON source:");
console.log(`     PREDICT_ADDRESS=${predict.address} \\`);
console.log("     DATA_URL=https://example.com/metric.json \\");
console.log("     REFERENCE_VALUE=1000 TOLERANCE_BPS=500 \\");
console.log("     npx hardhat run scripts/create-demo-market.ts");
console.log("No frontend or GitHub Pages site is part of this fork.");
